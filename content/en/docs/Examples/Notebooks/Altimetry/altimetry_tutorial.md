...
```
    ...
    Altimetry object at 0x557b021e4900 initialised
...
```
    ...
    Subsetting Altimetry object at 0x557b021e4900 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x557b021e4900 "ssh" with time_interp "nearest"
